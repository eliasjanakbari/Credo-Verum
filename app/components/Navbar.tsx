...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className={`bg-white border-b border-slate-200 shadow-sm ${mobileMenuOpen ? 'lg:block hidden' : ''}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center lg:justify-between h-16 relative">
            ...
            <div className="border-b border-slate-200">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-center h-16 relative">
                  <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity" onClick={() => setMobileMenuOpen(false)}>
                    <img src="/icons/Agnus-Dei-Logo.png" alt="Agnus Dei" className="h-7 w-7 object-contain" />
                    <span className="font-cinzel text-lg font-semibold text-slate-900">Credo Verum</span>
                  </Link>
                  <button
